...
- Wenn ein PR das vorgebaute Image nutzt, verifiziert der Workflow zusätzlich die darin installierte `@playwright/test`-Version gegen die in `package-lock.json` aufgelöste Checkout-Version; bei Abweichung wird automatisch lokal gebaut.
