...
- Wenn ein PR das vorgebaute Image nutzt, verifiziert der Workflow zusätzlich die darin installierte `@playwright/test`-Version gegen den aktuellen Checkout; bei Abweichung wird automatisch lokal gebaut.
