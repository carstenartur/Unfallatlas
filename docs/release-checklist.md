...
> Übersicht der Betriebsmodi: siehe README → *Betrieb und Entwicklung*.
...
- [ ] Dokumentationsmedien: `npm run validate:media` ist grün; README und Nutzungsanleitung enthalten kein veraltetes fest eingebettetes Demo-Video.
