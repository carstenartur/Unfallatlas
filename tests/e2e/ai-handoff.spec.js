...
test.describe('Nutzerseitige KI-Übergabe', () => {
  test('built application makes the reproducible analysis URL the primary path', async ({ page }) => {
    ...
    await expect(page.locator('#externalAiPromptPanel > div:first-child')).toContainText(/Analyse-Link.*PDF-\/Word-Export/i);
