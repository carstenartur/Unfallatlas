...
If you use **Unfallwerkbank**, please cite the archived software release and the repository.

## Preferred citation

Carsten Hammer. **Unfallwerkbank**. Version 2.1.3-SNAPSHOT. 2026. Software. GitHub repository: https://github.com/carstenartur/Unfallatlas
...
```bibtex
@software{hammer_unfallwerkbank_2026,
